                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="Numero de terminal" id="numTerminal" name="numTerminal" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="Numero de terminal" id="numTerminal2" name="numTerminal2" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
