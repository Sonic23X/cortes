                                ...
                                <table class="bg-white table table-bordered nowrap rounded shadow-xs border-xs" cellspacing="0">
                                    <thead>
                                        ...
                                        @foreach ($accounts as $account)
                                            <th>
                                                <a href="{{ url('/flujo/cuenta/' . $account->id) }}">
                                                    {{ $account->name }}
                                                </a>
                                            </th>
                                        @endforeach
                                ...
                                <table id="tablaFlow" class="table table-bordered table-striped text-center">
                                    ...
                                    @foreach ($movements as $movement)
                                        <tr>
                                            ...
                                            <td>${{ $movement[6] }}</td>
                                            <td>
                                                <a href="{{ url('/flujo/' . $movement[7] .'/edit') }}" class="text-primary" style="cursor:pointer;">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a onclick="removeRow({{ $movement[7] }})" class="text-danger" style="cursor:pointer;">
